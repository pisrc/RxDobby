...
public struct DConstraintsBuilder {
    ...
    public func addView(_ view: AnyObject, name: String) -> DConstraintsBuilder {
    ...
    public func addOnlyViewName(_ view: AnyObject, name: String) -> DConstraintsBuilder {
        var const = self
        const.views[name] = view
        return const
    }
    
    public func addMetricValue(_ value: AnyObject, name: String) -> DConstraintsBuilder {
        var const = self
        const.metrics[name] = value
        return const
    }
    
    public func addVFS(_ vfs: String, options: NSLayoutFormatOptions) -> DConstraintsBuilder {
        var const = self
    ...
    public func addVFS(_ vfsArray: String...) -> DConstraintsBuilder {
        var const = self
        for vfs in vfsArray {
